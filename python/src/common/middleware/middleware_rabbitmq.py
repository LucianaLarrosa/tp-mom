    ...
    def start_consuming(self, on_message_callback):
        try:
            ...
            self.channel.basic_consume(
                ...
                on_message_callback=self._pika_callback
            )
            self.channel.start_consuming()
        except (pika.exceptions.AMQPConnectionError, pika.exceptions.ConnectionClosedByBroker, pika.exceptions.StreamLostError):
